...
# ╔═╡ a7576fdc-9872-11f0-281d-cb5747a447fb
using JLD2, Optim, FHist

# ╔═╡ e89fa05f-ac8d-40f6-827c-20e0ccaabbec
struct WeightedTau
	tau::Float64
	weight::UInt32
end

# ╔═╡ f7108d0d-686e-4650-845f-af8fdc851d9d
struct ParsedData
...
# ╔═╡ 249a5cde-5f07-4d10-8f37-799dbfa8def2
struct BinnedData
...
# ╔═╡ 1fc9fc32-f1b0-4239-934b-a4925de028d6
function MLP(params, T, N)
...
# ╔═╡ b68cf10e-52eb-447c-9797-f34e566e4100
...
# ╔═╡ 28884e6c-557b-4dd9-bb3b-0ccec96349dd
# ╠═╡ disabled = true
#=╠═╡
GenData(["800"])
  ╠═╡ =#
...
manifest_format = "2.0"
project_hash = "258c0e534e3b454671946cdef4492984ea5cd8fa"
